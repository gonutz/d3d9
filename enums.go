...
type COMPOSERECTSOP uint32

const (
	COMPOSERECTS_COPY COMPOSERECTSOP = C.D3DCOMPOSERECTS_COPY
	COMPOSERECTS_OR                  = C.D3DCOMPOSERECTS_OR
	COMPOSERECTS_AND                 = C.D3DCOMPOSERECTS_AND
	COMPOSERECTS_NEG                 = C.D3DCOMPOSERECTS_NEG
)
...
const (
	DEVTYPE_HAL     DEVTYPE = C.D3DDEVTYPE_HAL
	DEVTYPE_NULLREF         = C.D3DDEVTYPE_NULLREF
	DEVTYPE_REF             = C.D3DDEVTYPE_REF
	DEVTYPE_SW              = C.D3DDEVTYPE_SW
)

type DISPLAYROTATION byte

const (
	DISPLAYROTATION_IDENTITY DISPLAYROTATION = C.D3DDISPLAYROTATION_IDENTITY
	DISPLAYROTATION_90                       = C.D3DDISPLAYROTATION_90
	DISPLAYROTATION_180                      = C.D3DDISPLAYROTATION_180
	DISPLAYROTATION_270                      = C.D3DDISPLAYROTATION_270
)
...
const (
	QUERYTYPE_VCACHE            QUERYTYPE = C.D3DQUERYTYPE_VCACHE
...
type SCANLINEORDERING byte

const (
	SCANLINEORDERING_PROGRESSIVE SCANLINEORDERING = C.D3DSCANLINEORDERING_PROGRESSIVE
	SCANLINEORDERING_INTERLACED                   = C.D3DSCANLINEORDERING_INTERLACED
)
...
const (
	...
	SWAPEFFECT_OVERLAY            = C.D3DSWAPEFFECT_OVERLAY
	SWAPEFFECT_FLIPEX             = C.D3DSWAPEFFECT_FLIPEX
)
